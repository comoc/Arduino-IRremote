...
#endif
{
	...
	for (int i = 0; i < IR_PARAMS_NUM; i++) {
		...
		if (pirparams->rawlen >= RAWBUF)  pirparams->rcvstate = STATE_OVERFLOW ;  // Buffer overflow

		switch(pirparams->rcvstate) {
			//......................................................................
			case STATE_IDLE: // In the middle of a gap
				if (irdata == MARK) {
					if (pirparams->timer < GAP_TICKS)  {  // Not big enough to be a gap.
						pirparams->timer = 0;

					} else {
						// Gap just ended; Record duration; Start recording transmission
						pirparams->overflow                  = false;
						pirparams->rawlen                    = 0;
			...
			case STATE_SPACE:  // Timing Space
				...
				} else if (pirparams->timer > GAP_TICKS) {  // Space
			...
			case STATE_STOP:  // Waiting; Measuring Gap
				if (irdata == MARK)  pirparams->timer = 0 ;  // Reset gap timer
				break;
				//......................................................................
			case STATE_OVERFLOW:  // Flag up a read overflow; Stop the State Machine
				pirparams->overflow = true;
				pirparams->rcvstate = STATE_STOP;
				break;
		}
		...
		if (pirparams->blinkflag) {
			if (irdata == MARK)
				if (pirparams->blinkpin) digitalWrite(pirparams->blinkpin, HIGH); // Turn user defined pin LED on
				else BLINKLED_ON() ;   // if no user defined LED pin, turn default LED pin for the hardware on
			else if (pirparams->blinkpin) digitalWrite(pirparams->blinkpin, LOW); // Turn user defined pin LED on
